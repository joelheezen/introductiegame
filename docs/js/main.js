    ...
    function Act3() {
        ...
        this.video.onended = function () {
            ...
            button1.addEventListener("click", function () {
                ...
                var text1 = "De Hofpleinfontein</br> Midden in het verkeersplein Hofplein staat een grote fontein. Deze Hofpleinfontein werd in 1939 aan de stad Rotterdam geschonken door de\u202Frederij Van Ommeren\u202Fdie zijn honderjarige bestaan vierde. De fontein wordt in de volksmond ook wel de\u202FFlipspuit\u202Fgenoemd, verwijzend naar Philippus \"Flip\" van Ommeren. Door de centrale ligging, pal naast de Coolsingel, is het een plaats geworden waar grote successen worden gevierd van voetbalclub\u202FFeyenoord\u202Fen het\u202FNederlands voetbalelftal. Bij die overwinningen\u202Fspringen en feesten supporters in de fontein.";
                var text2 = "Rotterdam Centraal Station</br> Het huidige stationsgebouw, gelegen aan het\u202FStationsplein, werd op 13 maart 2014 officieel geopend door koning\u202FWillem-Alexander.\u202FHet ontwerp verwierf meerdere internationale prijzen. Maar Rotterdammers hebben hun stationsgebouw zoals gewoonlijk een minder flatteuze bijnaam gegeven! ";
                var text3 = "Feyenoordstadion</br> \u201CGa je mee naar het stadion, naar de club van Rood en Wit\u201D. Dit stadion is beter bekend onder de naam \u2026\u2026\u2026. ";
                var text4 = "'De Belichaamde Eenheid'</br> Dit kunstwerk stond ooit bij de ingang van een van de locaties van Hogeschool Rotterdam (Museumpark Hoogbouw); destijds het hoofdkantoor van Unilever. Bij de verhuizing naar de Weena is het kunstwerk meeverhuisd. ";
                var text5 = "Erasmusbrug</br> De Erasmusbrug is een verhaal apart en heeft wel meer dan 20 bijnamen, waaronder \u2018de Zwaan\u2019, \u2018de Harp\u2019 en 'de Wipkip\u2019. Toch is \u2018de Zwaan\u2019 de meest gebruikte bijnaam. ";
                var text6 = "Station Blaak</br> De opdracht die de architect had bij het ontwerpen van het station was dat er voldoende ori\u00EBntatiepunten moesten zijn voor de reizigers. Dit is ook de reden dat de architect een opvallende constructie boven de grond maakte, zodat het station meteen opvalt en te herkennen is. Het ontwerp lijkt een beetje op een vliegende schotel. Veel mensen noemen het ook een verwelkte zonnebloem of fluitketel. Voor die laatste bijnaam moet je wel iets meer fantasie hebben.. ";
                var text7 = "Erasmus Medische Centrum</br> Op 1 juni 2002 fuseerden het Dijkzigtziekenhuis, het Sophia Kinderziekenhuis, de Daniel den Hoedkliniek en de \"Faculteit der Geneeskunde en Gezondheidswetenschappen\" van de Erasmus Universiteit Rotterdam tot het huidige Erasmus MC. \u201CGroot, wit, vierkant\u2026. Ik begrijp het wel\u201D zei een Rotterdammer over de bijnaam van dit gebouw. ";
                var text8 = "Binnenrotte</br> Hier wordt op dinsdag en zaterdag markt gehouden. Daarnaast wordt het plein ook veelvuldig gebruikt voor evenementen. Opgravingen hebben aangetoond dat de vroegste nederzettingen aan de rivier de Rotte hier het begin van de stad Rotterdam hebben ingeluid. De Binnenrotte is een grote, open ruimte en daar is ook de bijnaam \u2018Landingsbaan\u2019 van afgeleid. ";
                var text9 = "Markthal</br> Deze koophemel herbergt delicatessen, verse producten, allerlei eettentjes, een supermarkt en slijterij. Toch komen de meeste toeristen voor iets anders. Camera\u2019s klikken onafgebroken en zijn allemaal gericht op het plafond van de iconische Markthal. Rotterdammers spreken trots over hun \u2018Sixtijnse Kapel\u2019. ";
                var text10 = "Centrale Bibliotheek</br> Aan de opvallende gele buizen aan de buitenkant van dit gebouw dankt de bibliotheek haar bijnaam. Waar doet het jou aan denken? Net als meer gebouwen in Rotterdam, draagt de bibliotheek een citaat van een beroemde Rotterdammer op de gevel: \u201CHeel de aarde is je vaderland\u201D schreef niemand minder dan Desiderius Erasmus. Bezoek ook eens de Erasmus Experience in de bibliotheek als je meer over deze grote denker wil leren. ";
                var text11 = "Beurstraverse</br> Deze verdiepte winkelstraat loopt onder de Coolsingel door. De onhandige trappen ogen misschien mooi, maar lopen voor geen meter! Grote ketens hebben hier allemaal een plek. ";
                var text12 = "De Blaaktoren Woontoren.</br> Voor Rotterdammers beter bekend als het \u2018potlood\u2019.  ";
                var text13 = "'De gestileerde bloem'</br> Dit naamloze kunstwerk is een geschenk van de Bijenkorf aan de stad Rotterdam. Het heeft later de titel \u2018de gestileerde bloem\u2019 gekregen. Sommige Rotterdammers noemen het gewoonweg \u2018het ding\u2019. Anderen zien er een spoorwegongeluk in.  ";
