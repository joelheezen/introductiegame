...
var Act1 = (function () {
    ...
    Act1.prototype.searchOnline = function () {
        ...
        button4.addEventListener("click", function () { return _this.studentenServiceCenter(); });
        ...
        button5.addEventListener("click", function () { return _this.studentenpas(); });
        ...
        button6.addEventListener("click", function () { return _this.lms(); });
        button7.style.width = "4vw";
        button7.style.height = "4vh";
        button7.style.transform = "translate(5vw, 5vh)";
        button7.style.opacity = "80%";
        button7.addEventListener("click", function () { return _this.goBack(); });
    };
