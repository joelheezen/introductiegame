    ...
    constructor(){
        ...
        this.video.onended = function() {
            ...
            button1.addEventListener("click" , function(){
                ...
                let text10 = `Centrale Bibliotheek</br> Aan de opvallende gele buizen aan de buitenkant van dit gebouw dankt de bibliotheek haar bijnaam. Waar doet het jou aan denken? Net als meer gebouwen in Rotterdam, draagt de bibliotheek een citaat van een beroemde Rotterdammer op de gevel: “Heel de aarde is je vaderland” schreef niemand minder dan Desiderius Erasmus. Bezoek ook eens de Erasmus Experience in de bibliotheek als je meer over deze grote denker wil leren. `
                let text11 = `Beurstraverse</br> Deze verdiepte winkelstraat loopt onder de Coolsingel door. De onhandige trappen ogen misschien mooi, maar lopen voor geen meter! Grote ketens hebben hier allemaal een plek. `
                let text12 = `De Blaaktoren Woontoren.</br> Voor Rotterdammers beter bekend als het ‘potlood’.  `
                let text13 = `'De gestileerde bloem'</br> Dit naamloze kunstwerk is een geschenk van de Bijenkorf aan de stad Rotterdam. Het heeft later de titel ‘de gestileerde bloem’ gekregen. Sommige Rotterdammers noemen het gewoonweg ‘het ding’. Anderen zien er een spoorwegongeluk in.  `
